...
public class StockWatcher implements EntryPoint {
	...
	private void loadStockWatcher() {
	    ...
	    //add styles to elements in the flex table
	 ...
	 // Assemble Add Stock panel.
		...
		//Associate the Main panel with the MTML host page.
	...
	/**
	 * Add stock to FlexTable. Esecuted when hte user clicks the addStockButton or presses enter in hte newSymbolTextBox
	 */
	private void addStock() {
		final String symbol = newSymbolTextBox.getText().toUpperCase().trim();
		newSymbolTextBox.setFocus(true);
		
		//Stock codes must be between 1 and 10 chars that are numbers, letters, or dots.
		...
		//Don't add the stock if it's allready in hte table.
	...
	private void updateTable(StockPrice price) {
		...
		//Format the data in the Price and Chane Fields
